import { GET_A_LOAN_DATA, GET_LOAN_DATA, GET_LOAN_DATA_ERROR, LOAN_DATA_LOADING_ENDS, LOAN_DATA_LOADING_STARTS } from './types'
    ...
    try {
      ...
      if (error.response) {
        if (error.response.status == 422) {
          dispatch({type: GET_LOAN_DATA_ERROR, payload:error})
